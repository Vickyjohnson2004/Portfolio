    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="#contact"
            className="hidden lg:flex items-center font-Ovo gap-3 px-10 py-2 border border-gray-500 rounded-full ml-4 text-sm lg:text-base"
          >
            Contact{" "}
        ...
        <ul
          ref={sideMenuRef}
          className="flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition-all duration-300"
        >
